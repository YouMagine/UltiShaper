...
define(function(require) {
  ...
  GitHubStore = (function() {
    function GitHubStore() {
      this.authentificate = __bind(this.authentificate, this);      this.driver = new GitHubRedirectDriver();
      /*
      @github = new Github
        token: "OAUTH_TOKEN"
        auth: "oauth"
  ...
  GitHubStore = (function(_super) {
    ...
    function GitHubStore(options) {
      ...
      this.login = __bind(this.login, this);      GitHubStore.__super__.constructor.call(this, options);
