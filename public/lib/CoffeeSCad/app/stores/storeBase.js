...
define(function(require) {
  var Backbone, LocalStorage, Project, ProjectLibrary, StoreBase, buildProperties, merge, reqRes, utils, vent;
  ...
  ProjectLibrary = (function(_super) {
    __extends(ProjectLibrary, _super);

    "a library contains multiple projects, stored in the stores specific storage";

    ProjectLibrary.prototype.model = Project;

    ProjectLibrary.prototype.defaults = {
      recentProjects: []
    };

    function ProjectLibrary(options) {
      ProjectLibrary.__super__.constructor.call(this, options);
    }

    ProjectLibrary.prototype.comparator = function(project) {
      var date;
  ...
  StoreBase = (function(_super) {
    ...
    function StoreBase(options) {
      ...
      this.lib = new ProjectLibrary();
      this.projectsList = [];
      this.cachedProjects = [];
      reqRes.addHandler("get" + this.storeShortName + "FileOrProjectCode", this._sourceFetchHandler);
    }
    ...
    StoreBase.prototype.saveProject_ = function(project, newName) {};
