...
class TranslationsControllerTest < ActionController::TestCase
  ...
  test "should create translation" do
    assert_difference('Translation.count') do
      post :create, translation: { fromtext: @translation.fromtext, language: @translation.language, translation: @translation.translation }
    end
  ...
  test "should update translation" do
    put :update, id: @translation, translation: { fromtext: @translation.fromtext, language: @translation.language, translation: @translation.translation }
    assert_redirected_to translation_path(assigns(:translation))
  end
